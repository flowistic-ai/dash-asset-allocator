...
tabs = dmc.Tabs(
    [
        ...
        dmc.TabsPanel(learn_card, value="learn"),
        dmc.TabsPanel(
            [
        ...
        dmc.TabsPanel([results_card, data_source_card], value="results"),
    ],
)
...
header = dmc.AppShellHeader(
    dmc.Group(
        [
            ...
            dmc.Text("Asset Allocation Visualizer", size="xl", ta="center"),
        ],
        h="100%",
        px="xl",
    ),
